...
public class QuanLi extends JFrame {
    ...
    JButton ChiTietLichKham = new JButton("Chi tiết khám bệnh");
    ...
    QuanLi(){
        ...
        ChiTietLichKham.addActionListener(this::ChiTietKhamBenhActionListener);
        ...
        ChiTietLichKham.setBounds(100, 250, 200, 50);
